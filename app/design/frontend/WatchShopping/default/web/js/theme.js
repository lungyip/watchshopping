define([
    ...
    $.widget('TemplateMonster.theme', {
        ...
        _create: function() {
            ...
            this._faqAccordion();
            this._doubleTapInit();
            console.log("watchshopping theme.js is initialized");
            $('body').click(function(){
            ...
            //Event: no respond clicking proceed to checkout and remove item button on minicart
            //Action: removed .rd-navbar-cart in onclick to stopPropagation function
            $('.rd-navbar-cart-toggle').on('click', function (f) {
                f.stopPropagation();
            });
        }
    });
